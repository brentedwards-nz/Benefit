...
export type ProgrammeCreateInput = Omit<Programme, 'id' | 'createdAt' | 'updatedAt'>;

export type ProgrammeUpdateInput = Partial<Omit<Programme, 'id' | 'createdAt' | 'updatedAt'>>;
...
export type ProgrammeTemplateCreateInput = Omit<ProgrammeTemplate, 'id'>;

export type ProgrammeTemplateUpdateInput = Partial<Omit<ProgrammeTemplate, 'id'>>;