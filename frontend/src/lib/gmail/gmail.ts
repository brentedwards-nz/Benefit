...
export async function getGmailClient() {
  // TODO: Implement with NextAuth and Prisma instead of Supabase
  throw new Error("Gmail functionality not implemented yet");
...
export async function sendEmail(to: string, subject: string, htmlBody: string) {
  ...
  throw new Error("Email sending functionality not implemented yet");
...
export async function readMostRecentEmail() {
  // TODO: Implement with NextAuth and Prisma
  throw new Error("Email reading functionality not implemented yet");
